...
# Import functions from extractor.py
from app.agents.extractor import process_pdf
...
async def extract_case_details(pdf_path):
    """
    Extract case details from PDF using the extractor module
    """
...
def main(pdf_path):
    try:
        ...
        # Extract case details using extractor.py
        features = extract_case_details_sync(pdf_path)
